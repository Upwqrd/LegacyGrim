...
import ac.grim.grimac.platform.bukkit.events.AntiPearlPhaseListener;
...
public class BukkitEventManager implements StartableInitable {
    public void start() {
        ...
        Bukkit.getPluginManager().registerEvents(new AntiPearlPhaseListener(), GrimACBukkitLoaderPlugin.LOADER);
    }
}
